# MySQL dump of database 'heritage4' on host 'localhost'
# Backup Date and Time: 2021-07-22 06:30
# Built by WizERP 
# /
# Company: HERITAGE
# User: Administrator
...
### Data of table `1_colors` ###

INSERT INTO `1_colors` VALUES
('1', 'Cerice'),
('2', 'Lilac'),
('3', 'Orange'),
('4', 'Pink'),
...
('1', 'DEMO', 'DEMO', NULL, 'DEMO', NULL, NULL, NULL, NULL, NULL, '', '0');
...
('KENYAN SHILLINGS', 'KES', 'KES', 'KENYA', 'CENTS', '1', '0'),
...
('1', '1', 'DEMO', 'DEMO', 'DEMO', '1', '1', 'DEF', '1', '', '4510', '1200', '4500', '1', 'DEMO', '0', '', NULL, '0');
...
CREATE TABLE `1_debtor_trans` (
  ...
  `c17_entry_number` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ecs_number` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
...
('1', 'DEMO', 'DEMO', 'DEMO', '', 'KES', '1', '0', '0', '1', '4', '0', '0', '1000', '', '0');
...
('4', '2021-07-01', '2022-06-01', '1');

### Structure of table `1_flower_boxes` ###

DROP TABLE IF EXISTS `1_flower_boxes`;

CREATE TABLE `1_flower_boxes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `box_item_id` varchar(80) NOT NULL,
  `flower_item_id` varchar(80) DEFAULT NULL,
  `stem_size` varchar(20) NOT NULL,
  `quantity` float NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;

### Data of table `1_flower_boxes` ###


### Structure of table `1_flowertype` ###

DROP TABLE IF EXISTS `1_flowertype`;

CREATE TABLE `1_flowertype` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 ;

### Data of table `1_flowertype` ###

INSERT INTO `1_flowertype` VALUES
('1', 'STANDARD'),
('2', 'SPRAYS PLUS REDS'),
('3', 'MUMS');
...
### Structure of table `1_item_settings` ###

DROP TABLE IF EXISTS `1_item_settings`;

CREATE TABLE `1_item_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_no` int(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 ;

### Data of table `1_item_settings` ###

INSERT INTO `1_item_settings` VALUES
('1', '20');
...
### Structure of table `1_items_types` ###

DROP TABLE IF EXISTS `1_items_types`;

CREATE TABLE `1_items_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 ;

### Data of table `1_items_types` ###

INSERT INTO `1_items_types` VALUES
('1', 'Harvest Item'),
('2', 'Regular Item');
...
('35', '1', '2021-05-29', 'CUU2001/2021', '', '2021-05-29', '2021-05-29', 'KES', '40.23', '1');
...
### Structure of table `1_lot_transactions` ###

DROP TABLE IF EXISTS `1_lot_transactions`;

CREATE TABLE `1_lot_transactions` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `doc_no` varchar(80) NOT NULL,
  `item_code` varchar(80) NOT NULL,
  `lot_number` varchar(100) NOT NULL,
  `po_detail_item` bigint(20) NOT NULL,
  `qty_in` int(11) DEFAULT '0',
  `qty_out` int(11) DEFAULT '0',
  `type` enum('grv','invoice') DEFAULT 'grv',
  `expiry_date` date DEFAULT NULL,
  `date_created` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;

### Data of table `1_lot_transactions` ###
...
CREATE TABLE `1_purch_order_details` (
  ...
  `grv_received` tinyint(1) DEFAULT '0',
...
('19', '30', '', '{001}/{YYYY}', '', '1', '0'),
('20', '32', '', '{001}/{YYYY}', '', '1', '0'),
('21', '35', 'CUU2', '{001}/{YYYY}', '', '1', '0'),
('22', '40', '', '{001}/{YYYY}', '', '1', '0'),
('23', '50', 'IR', '{001}/{YYYY}', '', '1', '0');
...
CREATE TABLE `1_sales_order_details` (
  ...
  `discount_percent` double NOT NULL DEFAULT '0',
  `inv_issued` tinyint(1) DEFAULT '0',
  `box_id` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
...
### Data of table `1_sizes` ###

INSERT INTO `1_sizes` VALUES
('1', '42 cm'),
('2', '52 cm'),
('3', '62 cm'),
('4', '72 cm');
...
('5', 'PACKING BOX', '1', 'each', 'B', '4010', '5010', '1510', '5040', '1530', '0', '0', '0', '1', '0');
...
CREATE TABLE `1_stock_master` (
  ...
  `lot_item` tinyint(1) DEFAULT '0',
  `item_type_id` int(11) DEFAULT '1',
...
CREATE TABLE `1_stock_moves` (
  ...
  `standard_cost` double NOT NULL DEFAULT '0',
  `qty_item_requested` int(11) DEFAULT '0',
...
('1', 'Test', 'test', '', '', '', '', '', '', '', 'KES', '4', '0', '0', '0', '1', '0', '', '2100', '5060', '', '0');
...
('coy_name', 'setup.company', 'varchar', '60', 'Wise &amp; Agile'),
...
('email', 'setup.company', 'varchar', '100', 'info@wizag.com'),
...
('gl_closing_date', 'setup.closing_date', 'date', '8', '2022-06-01'),
...
('phone', 'setup.company', 'varchar', '30', '0701234567'),
('po_over_charge', 'glsetup.purchase', 'int', '11', '10'),
('po_over_receive', 'glsetup.purchase', 'int', '11', '10'),
('postal_address', 'setup.company', 'tinytext', '0', 'Westlands Unga House, Nairobi Kenya.'),
...
('1', 'admin', '5f4dcc3b5aa765d61d8327deb882cf99', 'Administrator', '2', '', 'adm@example.com', 'C', '0', '0', '0', '0', 'canvas', 'Letter', '2', '2', '4', '1', '1', '0', '0', '2021-07-22 06:27:53', '10', '1', '1', '', '1', '0', 'orders', '30', '0', '1', '0', '0', '0');

### Structure of table `1_varieties` ###
...
### Data of table `1_varieties` ###

INSERT INTO `1_varieties` VALUES
('1', 'Athena'),
('2', 'Be/Labell'),
('3', 'Bellarose'),
('4', 'Carice'),
